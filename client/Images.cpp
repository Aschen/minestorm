...
void Images::loadImages()
{
    ...
    _images[Element::SHIP_1] = QSharedPointer<QImage>(new QImage("images/void_viper.png"));
    ...
    _images[Element::SHOT] = QSharedPointer<QImage>(new QImage("images/shot_model.png"));
}
